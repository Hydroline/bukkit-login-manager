...
/* loaded from: LoginManager v1.34.jar:org/nanfans/LoginListener.class */
public class LoginListener implements Listener {
    ...
    /* JADX WARN: Type inference failed for: r0v39, types: [org.nanfans.LoginListener$1] */
    ...
    public void onLogin(PlayerJoinEvent login) {
        ...
        if ((pastTime.longValue() < LoginManager.max_time.longValue() * 60 && pastTime.longValue() > 0) || LoginManager.max_time.longValue() == 0) {
            new BukkitRunnable() { // from class: org.nanfans.LoginListener.1
                public void run() {
